...
<head>
    ...
    <link rel="stylesheet" href="../Filaments/filamentcolors.css">
    ...
    <div class = "card-wrapper">
        <div class = "cards">
          ...
          <div class = "product-imgs">
            <div class = "img-display">
              <div class = "img-showcase">
                <img src = "../3D_Printers/images/x3045/1.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/x3045/5.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/x3045/6.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/x3045/7.jpg" alt = "Kids 1.0 3D Printer">
              </div>
            </div>
          ...
          <div class = "product-content">
            <h2 class = "product-title">CoLiDo X3045</h2>
            ...
            <div class = "product-detail">
              ...
              <p>CoLiDo X3045 is the mid-size 3D Printer for industrial use. Not only itsincredible build volume of 300 x 300 x 450mm allows to make industrial-type prints, but also with robust structure helps reduce shaking printing<br>The only 3D printer brand allows toolless print object removal – SIMPLY BY YOUR HAND!<br>
                Extra large build size – 11.8″ x 11.8″ x 17.7″ (30 x 30 x 45 cm)<br>
                Clean and easy to use<br>
                Industrial level quality and smooth build surface – up to 0.1 mm resolution<br>
                Stable and quiet</p>
              
              <ul>
                <!-- <li>Colors: <span>Black, White, Red, Green, Grey, Natural, Purple, Orange, Yellow, Blue</span></li> -->
                <li>Available: <span>In stock</span></li>
                <li>Category: <span>3D Printer</span></li>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
   <script src="../Filaments/filament.js"></script>
    </body>
</html>