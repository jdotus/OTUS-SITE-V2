    ...
    <div class = "card-wrapper">
        <div class = "cards">
          ...
          <div class = "product-imgs">
            <div class = "img-display">
              <div class = "img-showcase">
                <img src = "../3D_Printers/images/kids 1.0/1.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/kids 1.0/2.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/kids 1.0/5.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/kids 1.0/6.jpg" alt = "Kids 1.0 3D Printer">
              </div>
            </div>
          ...
          <div class = "product-content">
            <h2 class = "product-title">CoLiDo Kids 1.0</h2>
            ...
            <div class = "product-detail">
              ...
              <p>CoLiDo Kids 1.0 3D Cartoon Printer is more than just a printer; it's a creative spark for young children. Designed for young children, it transforms their wildest ideas into reality, nurturing innovation. Birthday Present Birthday Gift for Kid.</p>
