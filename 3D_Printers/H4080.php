    ...
    <div class = "card-wrapper">
        <div class = "cards">
          ...
          <div class = "product-imgs">
            <div class = "img-display">
              <div class = "img-showcase">
                <img src = "../3D_Printers/images/CoLiDo H4080/1.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/CoLiDo H4080/2.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/CoLiDo H4080/4.jpg" alt = "Kids 1.0 3D Printer">
                <img src = "../3D_Printers/images/CoLiDo H4080/6.jpg" alt = "Kids 1.0 3D Printer">
              </div>
            </div>
          ...
          <div class = "product-content">
            <h2 class = "product-title">CoLiDo H3045</h2>
            ...
            <div class = "product-detail">
              ...
              <p>The CoLiDo H4080 is a professional FDM 3D printer designed for industrial applications that demand high precision, reliability, and versatility. Packed with innovative features, it delivers exceptional results for users who need to produce high-strength parts for various industries.</p>
