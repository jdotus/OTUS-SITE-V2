    ...
    <div class = "card-wrapper">
      <div class = "cards">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "filament_image/TPU/tpu_1.webp" alt = "filament image">
              <img src = "filament_image/TPU/tpu_2.webp" alt = "filament image">
              <img src = "filament_image/TPU/tpu_3.webp" alt = "filament image">
              <img src = "filament_image/TPU/tpu_4.webp" alt = "filament image">
            </div>
          </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">TPU Filament</h2>
          ...
          <div class = "product-detail">
            ...
            <p>CoLiDo ABS filament is a strong, heat-resistant material that works with most 3D printers (1.75mm diameter) to create smooth, detailed prints. It's easy to use with recommended printing temperatures and comes on convenient spools for uninterrupted printing. The filament is well-made to prevent jams and bubbles for consistent, high-quality results.</p>
            
            <ul>
              <li>Colors: <span>Black, White, Green, Red, Orange, Blue, Grey</span></li>
              <li>Available: <span style="color: red;">No Stock</span></li>
