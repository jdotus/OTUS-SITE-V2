    ...
    <div class = "card-wrapper">
      <div class = "cards">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "filament_image/PLA/pla_1.webp" alt = "filament image">
              <img src = "filament_image/PLA/pla_2.webp" alt = "filament image">
              <img src = "filament_image/PLA/pla_3.webp" alt = "filament image">
              <img src = "filament_image/PLA/pla_4.webp" alt = "filament image">
            </div>
          </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">PLA Filament</h2>
          ...
          <div class = "product-detail">
            ...
            <p>COLIDO PLA filament is easy to use (thanks to their neat winding device), works with most printers (1.75mm FDM), and produces high-quality prints (accurate details, smooth surfaces). It requires standard printing temperatures and comes on spools designed for easy replacement. The filament itself is high-quality, with consistent performance due to advanced technology and careful drying.</p>
            
            <ul>
              <li>Colors: <span>White, Black, Purple, Red, Green, Yellow, Natural, Orange, Silver, Transparent, Grey, Cyan, Grass Green, Luminous Sky Blue,
                Florescence, Pink, Matte Blue, Golden, Flourescent Green, Rose Red, Blue, Lite Blue, Matte Grey, Natural, Skin Color, Brown, Flourescent Blue, Flourescent Orange</span></li>
