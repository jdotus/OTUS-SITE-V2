...
<!-- SERVICES PART -->
<div class="main_container_services">

    <div class="service_description">
        <h1 class="test-1">OUR <span class="gradient_span">SERVICES</span></h1>
        <hr class="test-1 award-sliders-divider">
        <p class="test-1">Ready for your next big project? We've got the tools to make it real, from crisp, fast photocopies that get your message out to innovative 3D prints that build tomorrow, today.</p>
    </div>

    <div class="services_container test-1">
        <div class="otus_mps test-1">     
            <img src="./img/TYTO & OTUS LOGO MPS/2D MPS SUQRE.png" alt="OTUS MPS">
            <div class="content">
        ...
        <div class="tyto_mps test-1">
            ...
            <div class="content">
                <h3>TYTO delivers complete 3D printing solutions</h3>
                <p>From desktop 3D printers to professional solutions, TYTO offers sales, training, and technical support to power your creativity and productivity.</p>
            </div>
